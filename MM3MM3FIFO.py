#Propuesta de mejora agregar un servidor a la primera linea
...
global media_servicio1_C
media_servicio1_C = 1/6
...
tiempo_proximo_evento=[0, 0, 0, 0, 0, 0, 0, 0]
num_eventos = 7

tiempo_arrivo1_A=[0] * (limite_cola+1)
tiempo_arrivo1_B=[0] * (limite_cola+1)
tiempo_arrivo1_C=[0] * (limite_cola+1)
...
def inicializar():
    ...
    tiempo_proximo_evento[7] = 1000000000000000000000
...
def servers1ocupados():
    ...
    global estado_server1_B
    global estado_server1_C
    if estado_server1_A == 1 and estado_server1_B == 1 and estado_server1_C == 1:
        return 1
    elif estado_server1_B == 0 :
        return 2
    elif estado_server1_A == 0 :
        return 3
    elif estado_server1_C == 0:
        return 5
    elif estado_server1_A == 0 and estado_server1_B == 0 and estado_server1_C == 0:
        return 4
...
def arrivo1():
    ...
    if estado == 1:
        if num_en_cola1_A<=num_en_cola1_B and num_en_cola1_A<=num_en_cola1_C:
        ...
        elif num_en_cola1_B<num_en_cola1_A and num_en_cola1_B<=num_en_cola1_C:
            num_en_cola1_B = num_en_cola1_B + 1
            num_en_cola = num_en_cola + 1
            if (num_en_cola1_B > limite_cola):
                print("Sobrecarga de limite cola en el tiempo:" + str(tiempo))
            tiempo_arrivo1_B[num_en_cola1_B] = tiempo
        elif num_en_cola1_C<num_en_cola1_A and num_en_cola1_C<num_en_cola1_B:
            num_en_cola1_C = num_en_cola1_C + 1
            num_en_cola = num_en_cola +1
            if (num_en_cola1_C > limite_cola):
                print("Sobrecarga de limite cola en el tiempo:" + str(tiempo))
            tiempo_arrivo1_C[num_en_cola1_C] = tiempo
    elif estado == 2:
        demora=0
        ...
        num_cliente_demorados = num_cliente_demorados + 1
        estado_server1_C = 1
        tiempo_proximo_evento[7] = tiempo + expon(media_servicio1_C)
...
def partida1_C():
    ...
    if (num_en_cola1_C==0):
        ...
        num_en_cola1_C=num_en_cola1_C-1
        demora = tiempo - tiempo_arrivo1_C[1]
        total_de_demoras = total_de_demoras + demora
        num_cliente_demorados= num_cliente_demorados+1
        tiempo_proximo_evento[7]= tiempo + expon(media_servicio1_C)
        for i in range (1, num_en_cola1_C+1 ):
            tiempo_arrivo1_C[i] = tiempo_arrivo1_C[i+1]
...
def actualizar_estadisticos():
    ...
    area_num_en_cola1_C = area_num_en_cola1_C + (num_en_cola1_C * tiempo_desde_ultimo_evento)
    ...
    area_estado_server1_C = area_estado_server1_C + estado_server1_C * tiempo_desde_ultimo_evento
...
def reportaje():
    ...
    print("Numero promedio de clientes en cola 1 C:" + str(area_num_en_cola1_C /tiempo))
    ...
    print("Utilizacion del server 1 C:" + str(area_estado_server1_C /tiempo))
...
def main():
    ...
    print("Tiempo de mediana de servicio server 1_C:" + str(media_servicio1_C) + " Horas")
...
global num_prom_cola1_CTotal
num_prom_cola1_CTotal = 0
...
global utilizacionServer1_Ctotal
utilizacionServer1_Ctotal = 0
...
def salvarEstadisticos():
    ...
    num_prom_cola1_CTotal = num_prom_cola1_CTotal + area_num_en_cola1_C / tiempo
    ...
    utilizacionServer1_Ctotal = utilizacionServer1_Ctotal + area_estado_server1_C / tiempo
...
def reportajeCorrida(n):
    ...
    print("Numero promedio de clientes en cola 1 C Total:" + str(num_prom_cola1_CTotal / n))
    ...
    print("Utilizacion del server 1 C Total:" + str(utilizacionServer1_Ctotal / n))
