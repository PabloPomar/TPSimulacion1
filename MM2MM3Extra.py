...
global tiempoEnServ1A
global tiempoEnServ1B
global tiempoEnServ2A
global tiempoEnServ2B
global tiempoEnServ2C
tiempoEnServ1A = []
tiempoEnServ1B = []
tiempoEnServ2A = []
tiempoEnServ2B = []
...
def arrivo1():
    ...
    if estado == 1:
        ...
        tiempoEnServ1B.append(tiempo_proximo_evento[3] - tiempo)
    elif estado == 3:
        demora=0
        total_de_demoras= total_de_demoras+ demora
        num_cliente_demorados= num_cliente_demorados+1
        ...
        tiempoEnServ1A.append(tiempo_proximo_evento[2] - tiempo)
    elif estado == 4:
        demora=0
        total_de_demoras= total_de_demoras+ demora
        num_cliente_demorados= num_cliente_demorados+1
...
def arrivo2():
    ...
    if (servers==1):
        ...
        if desocupado == 1:
            ...
            tiempoEnServ2A.append(tiempo_proximo_evento[4] - tiempo)
        elif desocupado == 2:
            num_cliente_demorados= num_cliente_demorados+1
            estado_server2_B=1
            tiempo_proximo_evento[5]= tiempo+ expon(media_servicio2_B)
            tiempoEnServ2B.append(tiempo_proximo_evento[5] - tiempo)
        elif desocupado == 3:
            num_cliente_demorados= num_cliente_demorados+1
            estado_server2_C=1
            tiempo_proximo_evento[6]= tiempo+ expon(media_servicio2_B)
            tiempoEnServ2C.append(tiempo_proximo_evento[6] - tiempo)
...
def reportaje():
    ...
    global tiempoEnServ2C
    global tiempo
    promCola =  total_de_demoras/num_cliente_demorados
    prom1erServ = average(tiempoEnServ1A) + average(tiempoEnServ1B)
    prom2doServ = average(tiempoEnServ2A) + average(tiempoEnServ2B) + average(tiempoEnServ2C)
    tiempoEnServ1 = sum(tiempoEnServ1A) + sum(tiempoEnServ1B)
    tiempoEnServ2 = sum(tiempoEnServ2A) + sum(tiempoEnServ2B) + sum(tiempoEnServ2C)
    print("Promedio de demoras en cola:" + str((total_de_demoras)/ (num_cliente_demorados)) + "Horas")
    #print("Promedio de demoras en primer servicio" + str(average(tiempoEnServ1A) + average(tiempoEnServ1B)) + "Horas")
    print("Promedio de demoras en primer servicio" + str(tiempoEnServ1 / num_cliente_demorados) + "Horas")
    #print("Promedio de demoras en segundo servicio" + str(average(tiempoEnServ2A) + average(tiempoEnServ2B) + average(tiempoEnServ2C)) + "Horas")
    print("Promedio de demoras en segundo servicio" + str(tiempoEnServ2 / num_cliente_demorados) + "Horas")
    print("Promedio total en el sistema: " + str(promCola + tiempoEnServ1 / num_cliente_demorados + tiempoEnServ2 / num_cliente_demorados))
