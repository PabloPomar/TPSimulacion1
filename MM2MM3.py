...
#Eventos Arribo a la cola1, Arrivo a la cola2 , partido del server 1_A, partida del server1_B , partida del server 2_A, partida del server 2_B, partida del server 2_C
...
def timing():
    ...
    for i in range(1, num_eventos+1):
        if(tiempo_proximo_evento[i]< tiempo_min_proximo_evento):
            ...
            sig_tipo_evento=i
            print("Siguiente tipo de evento:" + str(sig_tipo_evento))
...
def arrivo2():
    ...
    if (servers==1):
        ...
        if desocupado == 1:
            num_cliente_demorados= num_cliente_demorados+1
            estado_server2_A=1
            tiempo_proximo_evento[5]= tiempo+ expon(media_servicio2_A)
        elif desocupado == 2:
            num_cliente_demorados= num_cliente_demorados+1
            estado_server2_B=1
            ...
            num_cliente_demorados= num_cliente_demorados+1
            estado_server2_C=1
            tiempo_proximo_evento[7]= tiempo+ expon(media_servicio2_B)
...
def partida2_C():
    ...
    if (num_en_cola2==0):
        ...
        total_de_demoras = total_de_demoras + demora
        num_cliente_demorados= num_cliente_demorados+1
        tiempo_proximo_evento[7]= tiempo + expon(media_servicio2_C)
        for i in range (1, num_en_cola2+1 ):
            tiempo_arrivo2[i] = tiempo_arrivo2[i+1]
...
def main():
    ...
    while (num_cliente_demorados< num_demora_requerido):
        print("Numero de clientes demorados:" + str(num_cliente_demorados))
